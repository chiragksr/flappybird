...
/// <summary>
/// Spritesheet for Flappy Bird: http://www.spriters-resource.com/mobile_phone/flappybird/sheet/59537/
/// Audio for Flappy Bird: https://www.sounds-resource.com/mobile/flappybird/sound/5309/
/// </summary>
public class FlappyScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (GameStateManager.GameState == GameState.Dead)
        {
            ...
            //verify if user wants to restart the game
    ...
    void FixedUpdate()
    {
        //only jump up and down on intro screen
        if (GameStateManager.GameState == GameState.Intro)
        {
